<%@ Page Title="" Language="VB" MasterPageFile="~/main.master" AutoEventWireup="false" CodeFile="customize_package.aspx.vb" Inherits="customize_package" %>
    ...
    <section class="ftco-section contact-section ftco-degree-bg">
    	<div class="container">
            ...
            <div class="row">
                ...
                <asp:Label ID="Label1" runat="server" Text="Customize Id"></asp:Label>
            ...
            <div class="row">
               ...
               <asp:Label ID="Label7" runat="server" Text="Budget"></asp:Label>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*" ControlToValidate="txtbudget"></asp:RequiredFieldValidator>
                </div>  
                </div>
                <div class ="col-md-4">
                <div class="form-group">
                       <asp:Label ID="Label15" runat="server" Text="Places"></asp:Label>
                <asp:TextBox ID="txtplaces" runat="server" class="form-control" TextMode="MultiLine" ></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="*" ControlToValidate="txtplaces"></asp:RequiredFieldValidator>
                </div>  
            </div>
                </div>
            <div class="row">
